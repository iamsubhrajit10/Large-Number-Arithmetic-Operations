...
gcc add.c limb_utils.c -o add -I.. -lm -lgmp -lz -mavx512f -O3 -funroll-all-loops -ffast-math -flto -march=native
...
do
    ...
    do
        ...
        do
            ...
            taskset -c $core_number ./add $bit_size $core_number $test_case $measure_type > experiments/console_logs/${bit_size}_${test_case_description}_${measure_type_description}.txt
        done
    done
done