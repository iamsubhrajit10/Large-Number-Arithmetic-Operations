...
void limb_t_add_n_2048(limb_t *result, limb_t *a, limb_t *b)
{
    ...
    __ADD_N_8((res_ptr + 32), (a_ptr + 32), (b_ptr + 32), &c_in, &c_out);
    c_in = c_out;
    __ADD_N_8((res_ptr + 24), (a_ptr + 24), (b_ptr + 24), &c_in, &c_out);
    c_in = c_out;
...
void limb_t_add_n_16384(limb_t *result, limb_t *a, limb_t *b)
{
    ...
    __ADD_N_4((res_ptr + 312), (a_ptr + 312), (b_ptr + 312), &c_in, &c_out);
    c_in = c_out;
...
void limb_t_add_n_32768(limb_t *result, limb_t *a, limb_t *b)
{
    ...
    __ADD_N_1((res_ptr + 630), (a_ptr + 630), (b_ptr + 630), &c_in);
    __ADD_N_2((res_ptr + 628), (a_ptr + 628), (b_ptr + 628), &c_in);
    __ADD_N_4((res_ptr + 624), (a_ptr + 624), (b_ptr + 624), &c_in, &c_out);
    c_in = c_out;
...
void limb_t_add_n_65536(limb_t *result, limb_t *a, limb_t *b)
{
    ...
    __ADD_N_1((res_ptr + 1260), (a_ptr + 1260), (b_ptr + 1260), &c_in);
    __ADD_N_4((res_ptr + 1256), (a_ptr + 1256), (b_ptr + 1256), &c_in, &c_out);
    c_in = c_out;
...
void limb_t_add_n_131072(limb_t *result, limb_t *a, limb_t *b)
{
    ...
    __ADD_N_1((res_ptr + 2520), (a_ptr + 2520), (b_ptr + 2520), &c_in);

    for (int i = 2504; i >= 0; i -= 8)
    {
        __ADD_N_8((res_ptr + i), (a_ptr + i), (b_ptr + i), &c_in, &c_out);
        c_in = c_out;
    }
...
void limb_t_add_n(limb_t *result, limb_t *a, limb_t *b)
{
    ...
    {
        limb_t_add_n_512(result, a, b);
    }
    else if (n <= 20)
    {
        limb_t_add_n_1024(result, a, b);
    }
    else if (n <= 40)
    {
