...
void limb_mul_n(limb_t *mul, limb_t *a, limb_t *b);
void __mul_acc_mul_AVX(limb_t *a, limb_t *b, limb_t *res);
void __mul_add_limbs(limb_t *res);
void __mul_adjust_limbs(limb_t *res);
uint64_t horizontal_sum_128(__m128i v);

// Uses Urdhva Tiryakbhyam algorithm for multiplication
void limb_mul_n(limb_t *a, limb_t *b, limb_t *res)
{
