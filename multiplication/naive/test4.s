...
.LFB6644:
	...
	vpaddq	48(%rdi), %xmm10, %xmm11
	vmovdqu	24(%rdi), %xmm4
	vpsrldq	$8, %xmm0, %xmm2
	vmovq	40(%rdi), %xmm6
	vmovdqu	96(%rdi), %xmm15
	vpsrldq	$8, %xmm11, %xmm13
	vpaddq	%xmm2, %xmm0, %xmm3
	vpaddq	80(%rdi), %xmm15, %xmm0
	vmovq	112(%rdi), %xmm2
	vpaddq	%xmm6, %xmm4, %xmm7
	vpaddq	%xmm13, %xmm11, %xmm14
	vpsrldq	$8, %xmm4, %xmm8
	vmovq	%xmm3, 8(%rdi)
	vpsrldq	$8, %xmm0, %xmm4
	vpaddq	%xmm2, %xmm0, %xmm3
	vpaddq	%xmm8, %xmm7, %xmm9
	vmovdqu	136(%rdi), %xmm6
	vpaddq	%xmm4, %xmm3, %xmm5
	vpaddq	120(%rdi), %xmm6, %xmm7
	vmovdqu	184(%rdi), %xmm12
	vmovq	%xmm14, 24(%rdi)
	vpaddq	152(%rdi), %xmm7, %xmm8
	vpaddq	168(%rdi), %xmm12, %xmm13
	vmovq	%xmm5, 32(%rdi)
	vpaddq	200(%rdi), %xmm13, %xmm14
	vmovq	216(%rdi), %xmm0
	vmovq	%xmm9, 16(%rdi)
	vmovdqu	224(%rdi), %xmm4
	vpsrldq	$8, %xmm8, %xmm10
	vpaddq	240(%rdi), %xmm4, %xmm5
	vmovdqu	256(%rdi), %xmm6
	vpaddq	%xmm0, %xmm14, %xmm1
	vpsrldq	$8, %xmm14, %xmm2
	vpaddq	272(%rdi), %xmm6, %xmm7
	vmovdqu	288(%rdi), %xmm12
	vpaddq	%xmm10, %xmm8, %xmm11
	vpaddq	304(%rdi), %xmm12, %xmm13
	vmovq	336(%rdi), %xmm0
	vpaddq	%xmm7, %xmm5, %xmm8
	vpaddq	320(%rdi), %xmm13, %xmm14
	vmovq	%xmm11, 40(%rdi)
	vpaddq	%xmm2, %xmm1, %xmm3
	vpsrldq	$8, %xmm8, %xmm10
	vmovdqu	344(%rdi), %xmm4
	vpaddq	%xmm0, %xmm14, %xmm1
	vpsrldq	$8, %xmm14, %xmm2
	vpaddq	%xmm10, %xmm8, %xmm11
	vmovq	%xmm3, 48(%rdi)
	...
	vmovq	%xmm11, 56(%rdi)
	vmovq	%xmm3, 64(%rdi)
	vpaddq	360(%rdi), %xmm4, %xmm5
	vpaddq	376(%rdi), %xmm5, %xmm6
	vmovdqu	392(%rdi), %xmm10
	vmovq	424(%rdi), %xmm13
	vpaddq	408(%rdi), %xmm10, %xmm11
	vpsrldq	$8, %xmm6, %xmm8
	vmovdqu	488(%rdi), %xmm12
	vmovdqu	432(%rdi), %xmm1
	vpaddq	%xmm8, %xmm6, %xmm9
	vpaddq	448(%rdi), %xmm1, %xmm2
	vpaddq	%xmm13, %xmm11, %xmm14
	vpsrldq	$8, %xmm11, %xmm15
	vmovdqu	464(%rdi), %xmm6
	vmovq	480(%rdi), %xmm8
	...
	vmovq	%xmm0, 80(%rdi)
	vpaddq	%xmm8, %xmm6, %xmm9
	vpaddq	%xmm14, %xmm12, %xmm15
	vpsrldq	$8, %xmm6, %xmm10
	vpaddq	%xmm4, %xmm2, %xmm5
	vpinsrq	$1, 504(%rdi), %xmm15, %xmm0
