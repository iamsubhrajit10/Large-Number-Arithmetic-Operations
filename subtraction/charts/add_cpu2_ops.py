...
data = {
    ...
    "PML_ADD Time (ns)": [3.1, 4.1, 5.1, 7.6, 14.5, 28, 55.2, 109.8, 218.8, 446],
    "Speedup (PML_ADD) Time": [1.97, 1.66, 1.71, 1.59, 1.48, 1.48, 1.57, 1.55, 1.59, 1.57],
    ...
    "Speedup (PML_ADD) Ops": [1.81, 1.72, 1.70, 1.60, 1.49, 1.47, 1.56, 1.55, 1.59, 1.56],
}
