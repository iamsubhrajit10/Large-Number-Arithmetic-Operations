...
# PML_SUB data
pml_ticks = [8, 12, 16, 22, 35, 65, 153, 285, 529, 1143]
pml_instructions = [19, 49, 68, 96, 156, 276, 516, 996, 1956, 3876]
pml_l1d_reads = [25, 33, 49, 79, 138, 265, 527, 1033, 2054, 4098]
pml_l1d_misses = [9, 5, 6, 18, 27, 49, 100, 198, 529, 738]
pml_l1d_miss_pct = [36.0, 15.2, 12.2, 22.8, 19.6, 18.5, 19.0, 19.2, 25.8, 18.0]
...
create_metric_plot("L1D Cache Reads", gmp_l1d_reads, pml_l1d_reads, None, 
                 "L1D Cache Reads", "add_l1d_reads_cpu1.svg")
...
create_metric_plot("L1D Cache Miss Percentage", gmp_l1d_miss_pct, pml_l1d_miss_pct, None, 
                 "L1D Cache Miss %", "add_l1d_miss_pct_cpu1.svg")
