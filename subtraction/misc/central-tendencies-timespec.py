...
def extract_central_tendencies(file_path):
    ...
    try:
        ...
        print(f"Error: Corrupted gzip file {file_path}. Skipping.")
...
def process_directory(subdir):
    ...
    output_base_dir = os.path.join(current_path, 'central-tendencies', 'timespec', subdir)
    ...
    for file_name in os.listdir(input_dir):
        ...
        if file_name.endswith('.csv.gz'):
            ...
            if len(parts) == 3:
                ...
                # Skip if the file was corrupted
