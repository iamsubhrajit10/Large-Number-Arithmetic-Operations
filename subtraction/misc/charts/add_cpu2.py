...
# New Data with Baseline values added
data = {
    "Bit Size": [256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072],
    "GMP_ADD Time (ns)": [6.1, 6.8, 8.7, 12.1, 21.5, 41.4, 86.7, 170.2, 347.9, 700.6],
    "PML_ADD Time (ns)": [3.1, 3.9, 5.1, 7.6, 12.7, 25, 47.2, 93.1, 183.7, 375.6],
    "Baseline_ADD Time (ns)": [4.80, 10.00, 16.20, 33.00, 71.20, 157.10, 333.30, 676.30, 1364.80, 2742.80],
    "Speedup (PML_ADD vs GMP) Time": [1.97, 1.74, 1.71, 1.59, 1.69, 1.66, 1.84, 1.83, 1.89, 1.87],
    "Speedup (PML_ADD vs Baseline) Time": [1.55, 2.56, 3.18, 4.34, 5.61, 6.28, 7.06, 7.26, 7.43, 7.30],
    "GMP_ADD Ops": [173771046, 153189405, 116583444, 82107176, 46464158, 24129813, 11566172, 5865885, 2877475, 1427702],
    "PML_ADD Ops": [314333542, 264190786, 198350079, 131121066, 78204071, 39300773, 21098120, 10753023, 5438661, 2663280],
    "Baseline_ADD Ops": [219002251, 99458001, 61202245, 30320259, 14014349, 6370168, 2989194, 1475603, 732449, 364608],
    "Speedup (PML_ADD vs GMP) Ops": [1.81, 1.72, 1.70, 1.60, 1.68, 1.63, 1.82, 1.83, 1.89, 1.87],
    "Speedup (PML_ADD vs Baseline) Ops": [1.44, 2.66, 3.24, 4.32, 5.58, 6.17, 7.06, 7.29, 7.43, 7.30]
}
