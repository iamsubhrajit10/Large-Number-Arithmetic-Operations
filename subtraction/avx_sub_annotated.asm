...
0000000000002b10 <sub_n>:
{
  ...
  return __builtin___snprintf_chk (__s, __n, __USE_FORTIFY_LEVEL - 1,
    ...
    FILE *first_loop_file = fopen(first_loop_filename, "a");
    ...
    FILE *second_loop_file = fopen(second_loop_filename, "a");
    ...
    FILE *other_area_file = fopen(other_area_filename, "a");
    ...
    if (first_loop_file == NULL || second_loop_file == NULL || other_area_file == NULL)
...
_mm512_cmplt_epi32_mask (__m512i __X, __m512i __Y)
{
  ...
  *(__m512i_u *)__P = __A;
  ...
  return __fprintf_chk (__stream, __USE_FORTIFY_LEVEL - 1, __fmt,
    ...
    fprintf(first_loop_file, "%llu\n", first_loop_end_ticks - first_loop_start_ticks);
    ...
    fprintf(second_loop_file, "%llu\n", second_loop_end_ticks - second_loop_start_ticks);
    ...
    total_other_area_ticks += (other_area_end_ticks - other_area_start_ticks);
