...
def process_directory(subdir, gmp_dir):
    ...
    input_dir = os.path.join(current_path, subdir, 'experiments/results/cputime_measurements/')
    gmp_input_dir = os.path.join(current_path, gmp_dir, 'experiments/results/cputime_measurements/')
    output_base_dir = os.path.join(current_path, 'cdf-charts', 'cputime', subdir)
