...
MODELS = {
    "baseline": {
        "compile": "gcc sub.c limb_utils.c perf_utils.c -o sub -lz -I. -O1 -fno-tree-vectorize",
        "dir": os.path.join(BASE_DIR, "baseline")
    },
    "gmp": {
        "compile": "gcc sub.c ../utils/perf_utils.c -o sub -lgmp -lz -I../utils -O1 -mavx512f -mavx512vl",
        "dir": os.path.join(BASE_DIR, "gmp")
    },
    "pml_sub": {
        "compile": "gcc sub.c ../utils/perf_utils.c ../utils/limb_utils.c -o sub -lz -I../utils -O1 -mavx512f -mavx512vl",
        "dir": os.path.join(BASE_DIR, "pml_sub")
    },
    "pml_sub_approx": {
        "compile": "gcc sub.c ../utils/perf_utils.c ../utils/limb_utils.c -o sub -lz -I../utils -O1 -mavx512f -mavx512vl",
        "dir": os.path.join(BASE_DIR, "pml_sub_approx")
    }
}
...
def run_test(model, size, mode, iteration):
    ...
    try:
        ...
        cmd = f"sudo taskset -c {CORE} ./sub {size} 0 0 2 {mode}"
