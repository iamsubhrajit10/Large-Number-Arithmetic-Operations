...
void make_equidistant(int *num1, int *num2, int *n_1, int *n_2)
{
    int n1 = *n_1;
    int n2 = *n_2;
...
void extract_prefix(int *num, int n, int store_index_start, int **num_set, int *num_set_col_size)
{
    if (n == 0)
        return;
    for (int i =0; i<n; i++)
...
void extract_suffix(int *num, int n, int store_index_start, int **num_set, int *num_set_col_size)
{
...
int* urdhva_tiryakbhyam(int *num1, int *num2, int num_len)
{
    ...
    extract_prefix(num1, num_len, 0, numset1, numset1_col_size);
    extract_suffix(num1, num_len, num_len, numset1, numset1_col_size);
    extract_prefix(num2, num_len, 0, numset2, numset2_col_size);
    extract_suffix(num2, num_len, num_len, numset2, numset2_col_size);
...
void main()
{
    ...
    char num1_str[] = "12345678";
    char num2_str[] = "98765432";
